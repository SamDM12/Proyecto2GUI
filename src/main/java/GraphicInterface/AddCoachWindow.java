 ...
 * @author chedr
 */
public class AddCoachWindow extends javax.swing.JFrame {
...
private void changeDays(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddCoachWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddCoachWindow().setVisible(true);
            }
        });
    }
